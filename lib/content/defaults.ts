...
export const contentDefaults: Record<string, string> = {
  ...
  "ticker.deadline": "Thursday noon MST — {remaining}",
  ...
  "faq.a5":
    "At the reveal: the moment the last ticket lands, or Thursday noon MST \u2014 whichever comes first. Until then you see nothing about anybody's picks. Not a side, not a chip, not a count of who took what. Exactly one thing is public before the reveal, and it is not a pick: the list of who hasn't submitted yet.",
  ...
  "dash.poll.eyebrow": "League poll",
  "dash.poll.closes": "Closes {when}",
  "dash.poll.closed": "Closed",
  "dash.poll.votes": "{n} votes",
  "dash.poll.change": "Change my vote",
  "dash.poll.your_vote": "your vote",
