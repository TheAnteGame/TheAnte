-- ============================================================================
-- ANTE — PRE-LAUNCH SEASON RESET  (SQL-editor variant, auto-commit)
-- Paste the WHOLE file into the SQL editor for project TheAnte and press Run.
-- One transaction: any error rolls everything back, guards re-enable with it.
-- Identical to scripts/reset-season.sql (tested end-to-end against the local
-- stack: correct end state, rollback-clean, all 7 guards restored, abort guard
-- fires without a commissioner) — only the commit placement differs, because
-- the SQL editor cannot hold a transaction open between runs.
-- ============================================================================
